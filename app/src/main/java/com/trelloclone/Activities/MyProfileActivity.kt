...
class MyProfileActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FirestoreClass().loadUserDate(this@MyProfileActivity)
        ...
        if (resultCode == Activity.RESULT_OK
            ...
            try {
                ...
                Glide
                    ...
                    .into(iv_user_image_profile) // the view in which the image will be loaded.
            } catch (e: IOException) {
                e.printStackTrace()
            }
        }
    ...
    // Create a function to upload the selected user image to storage and get the url of it to store in the database.)
    // START
    ...
    //  Create a function to get the extension of the selected image.)
    // START
    /**
    ...
    //  Create a function to notify the user profile is updated successfully.)
    // START
    /**
